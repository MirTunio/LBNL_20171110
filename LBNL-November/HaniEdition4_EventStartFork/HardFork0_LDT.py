...
tdms_files = tdms_files[:35]#['8_16_2017_3_22_39_PM.tdms']
...
for i in np.arange(len(LOG)):
    ...
    temp = {'File':FILE,'Start':START,'Stop':STOP,'S1':None,'S2':None,'S3':None,'S4':None,'S5':None,'S6':None,'S8':None,'S9':None}
...
#        print(COLS[colnum],FILE)
    ...
    BESTLOG.to_csv('First20Events_BESTOF_20170930_ALL_CHANNELS.csv')
