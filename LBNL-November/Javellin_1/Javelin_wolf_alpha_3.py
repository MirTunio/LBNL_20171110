...
def SecondPass(MacroEventLog,AcousticData,filename):
    ...
    for i in np.arange(len(MacroEventLog)):
        ...
        EntropyEnvelopeA = MakePreciseEnvelope(AcousticData[C[0]].iloc[strt+200:strt+2200]) 
        EntropyEnvelopeB = MakePreciseEnvelope(AcousticData[C[1]].iloc[strt+200:strt+2200])
        
        precise_A = getStart(EntropyEnvelopeA) + 200
        precise_B = getStart(EntropyEnvelopeB) + 200
...
#    STOP.index = STOP.index*1000
    ...
    pBOT = AcousticData.iloc[strt+500:strt+2000]["/'3.051758E-5 ; 6.103516E-5 ; 6.103516E-5 ; 1.525879E-5 ; '/'S_bot'"]
    pTOP = AcousticData.iloc[strt+500:strt+2000]["/'3.051758E-5 ; 6.103516E-5 ; 6.103516E-5 ; 1.525879E-5 ; '/'S_top'"]
    
    JAM = AcousticData.iloc[strt+500:strt+2000].index
