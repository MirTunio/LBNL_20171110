...
#%%
#
PreciseLog = SecondPass(LogNew, AcousticData, tdms_files[0])
...
make ahenvve faster and higher up the processing chain...
'''
#%%
def AHenv(dfseries):
    factor=50
...
MacroLog['Validate'] = gem

LogNew = MacroLog[MacroLog.Validate].copy()
#%%
